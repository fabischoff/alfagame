               ...
               <section class="container content ">    
                    ...
                    <div class="container-jogo center-block ">
                         <div class="repositorio pull-left">
                              <p>palavras</p>
                              <button id="m" class="arrastar maca" >MAÇÃ</button>
                              <button id="p" class="arrastar pera" >PERA</button>
                              <button id="l" class="arrastar limao" >LIMÃO</button>
                              <button id="c" class="arrastar coco" >COCO</button>
                              <button id="u" class="arrastar uva" >UVA</button>
                         </div>
